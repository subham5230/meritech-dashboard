...
export function LtmRevenueChart({ companyId }: LtmRevenueChartProps) {
  ...
  const {
    ...
    isLoading,
    error,
  } = trpc.companyProfiles.getLtmRevenueData.useQuery({
    companyId,
  });
    ...
    <div className="relative">
      ...
      <div className="relative w-full" style={{ height: chartHeight }}>
        ...
        >
          ...
          {chartData.map((point: any, index: any) => {
            ...
            const barHeight = getBarHeight(point.ltmRevenue, maxRevenue);
          ...
          >
            ...
            <div className="space-y-1">
              <div className="text-green-600">
                Revenue (LTM) ($B): ${hoveredPoint.ltmRevenue.toFixed(1)}B
              </div>
              <div className="text-blue-600">
                % YoY Revenue Growth (LTM): {hoveredPoint.yoyGrowth}%
              </div>
            </div>
          </div>
        )}
      ...
      <div className="flex justify-center gap-6 mt-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-700">Revenue (LTM) ($B)</span>
        </div>
        <div className="flex items-center gap-2">
